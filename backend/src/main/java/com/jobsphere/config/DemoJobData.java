...
public class DemoJobData {
 ...
 CommandLineRunner seedCatalogJobs(JobRepository jobs, JdbcTemplate jdbc){
  return args -> {
   ...
   add(jobs,"Software Engineer","Apple","Hyderabad, India","Full-time","Early career","₹10–22 LPA","Software engineering role for the simulated JobSphere workflow.","Swift, Java, C++, Algorithms");
   add(jobs,"Software Engineer","Meta","Bengaluru, India","Full-time","Early career","₹14–28 LPA","Product engineering role used for the demo application pipeline.","React, Python, Java, Distributed Systems");
   ...
   add(jobs,"Associate Software Engineer","IBM","Bengaluru, India","Full-time","Entry-level","₹5–11 LPA","Entry-level technology role for the simulated recruitment workflow.","Java, Python, Cloud, SQL");
   add(jobs,"Application Developer","Accenture","Hyderabad, India","Full-time","Entry-level","₹5–10 LPA","Technology consulting role used in the demo portal.","Java, Spring Boot, SQL, Cloud");
   add(jobs,"Systems Engineer","Infosys","Hyderabad, India","Full-time","Entry-level","₹4–9 LPA","Graduate technology role for the simulated application flow.","Java, Python, SQL, Cloud");
   add(jobs,"Assistant System Engineer","TCS","Hyderabad, India","Full-time","Entry-level","₹4–9 LPA","Technology services role for the JobSphere simulation.","Java, SQL, Python, Git");
   add(jobs,"Software Development Engineer","Oracle","Hyderabad, India","Full-time","Early career","₹8–18 LPA","Cloud and database engineering role for the simulated workflow.","Java, OCI, SQL, Cloud");
   add(jobs,"Software Engineer","Adobe","Noida, India","Full-time","Early career","₹10–22 LPA","Product engineering role used for this demo recruitment system.","Java, C++, JavaScript, Algorithms");
  };
 }
