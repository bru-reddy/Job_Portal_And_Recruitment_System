...
async function request(path,options={}){
 ...
 try{
  ...
  if(err.name==="AbortError") throw new Error("The JobSphere server did not respond within 90 seconds.");
  if(err instanceof TypeError) throw new Error("Unable to reach the JobSphere server. Check the API URL and backend service.");
  throw err;
